...
- **Mouse isn't forwarded into panes.** Clicks/wheel/drag drive mmux's own focus, scrollback, and
  copy — so an inner program's mouse (e.g. a TUI you run in a terminal) doesn't receive events.
